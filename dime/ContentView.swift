...
struct ContentView: View {
    ...
    @AppStorage("showNotifications", store: UserDefaults(suiteName: "group.com.projecta.lira")) var showNotifications: Bool = false
    @AppStorage("notificationsEnabled", store: UserDefaults(suiteName: "group.com.projecta.lira")) var notificationsEnabled: Bool = true

    @AppStorage("firstLaunch", store: UserDefaults(suiteName: "group.com.projecta.lira")) var firstLaunch: Bool = true

    // adds category orders
    @AppStorage("dataMigration1", store: UserDefaults(suiteName: "group.com.projecta.lira")) var dataMigration1: Bool = true

    // converts category colors to hex codes
    @AppStorage("dataMigration2", store: UserDefaults(suiteName: "group.com.projecta.lira")) var dataMigration2: Bool = true
    ...
    @AppStorage("topEdge", store: UserDefaults(suiteName: "group.com.projecta.lira")) var savedTopEdge: Double = 30
    @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.projecta.lira")) var savedBottomEdge: Double = 15

    // updateSheetShowing

    @AppStorage("previousVersion", store: UserDefaults(suiteName: "group.com.projecta.lira")) var previousVersionString: String = "Version \(UIApplication.appVersion ?? "") (\(UIApplication.buildNumber ?? ""))"

    @AppStorage("showUpdateSheet", store: UserDefaults(suiteName: "group.com.projecta.lira")) var showUpdateSheet: Bool = true
    ...
    var body: some View {
        ...
        .onAppear {
//            UserDefaults(suiteName: "group.com.projecta.lira")!.set(false, forKey: "newTransactionAdded")
//            WidgetCenter.shared.reloadTimelines(ofKind: "TemplateTransactions")
            ...
            let defaults =
                UserDefaults(suiteName: "group.com.projecta.lira") ?? UserDefaults.standard
