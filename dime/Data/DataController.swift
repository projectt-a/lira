...
//        description.cloudKitContainerOptions = NSPersistentCloudKitContainerOptions(containerIdentifier: "iCloud.com.projecta.lira")
        description.cloudKitContainerOptions = nil

        let groupID = "group.com.projecta.lira"
...
////        }
    ...
    var addedTransaction: Bool {
        get {
            UserDefaults(suiteName: "group.com.projecta.lira")!.bool(forKey: "newTransactionAdded")
        }

        set {
            UserDefaults(suiteName: "group.com.projecta.lira")!.set(newValue, forKey: "newTransactionAdded")
        }
    }
    ...
    func fetchRequestForLogView(type: Int, optionalIncome: Bool?, categoryFilters: [Category] = []) -> NSFetchRequest<Transaction> {
        ...
        if type == 5 {
            ...
            if type == 1 {
                ...
                let startOfMonth = UserDefaults(suiteName: "group.com.projecta.lira")!.integer(forKey: "firstDayOfMonth")
