...
struct TemplateTransactionView: View {
    ...
    @AppStorage("numberEntryType", store: UserDefaults(suiteName: "group.com.projecta.lira")) var numberEntryType: Int = 1

    @Environment(\.colorScheme) var colorScheme

    @AppStorage("topEdge", store: UserDefaults(suiteName: "group.com.projecta.lira")) var topEdge: Double = 30
    ...
    @AppStorage("firstTransactionViewLaunch", store: UserDefaults(suiteName: "group.com.projecta.lira")) var firstLaunch: Bool = true
